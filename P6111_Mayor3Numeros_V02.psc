Algoritmo P6111_Mayor3Numeros_V02
	...
	Mientras calcular==Verdadero Y SioNo=='Si' Hacer
		...
		SiNo
			...
			SiNo
				Si numero1>numero2 Y numero1>numero3 Entonces // octavo Si
					Escribir "El mayor es número1 ",numero1
			SiNo Si numero2>numero1 Y numero2>numero3 Entonces // noveno Si
					Escribir "El mayor es número2 = ",numero2
			SiNo Si numero3>numero1 Y numero3 > numero2 Entonces // décimo Si
